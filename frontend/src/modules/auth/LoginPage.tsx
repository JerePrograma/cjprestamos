...
export function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-transparent px-4 py-8">
      <form onSubmit={onSubmit} className="panel w-full max-w-md p-7 sm:p-8">
        ...
        <div className="mt-6 space-y-4">
          <label className="block text-sm">
            <span className="mb-1 block text-slate-700 dark:text-slate-200">Usuario</span>
            <input
              value={usuario}
          ...
          <label className="block text-sm">
            <span className="mb-1 block text-slate-700 dark:text-slate-200">Contraseña</span>
            <input
              type="password"
              value={password}
