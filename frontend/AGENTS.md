...
5. Separación mental entre datos operativos y legajo
...
- La pantalla principal debe destacar:
  ...
  - deuda total,
  - préstamos activos.
- No priorizar recordatorios, alertas ni vencimientos complejos en el MVP.
- La vista de `Persona` debe diferenciar claramente:
  - datos básicos,
  - préstamos actuales,
  - legajo cuando exista.
...
- Usar componentes reutilizables, sin abstraer de más.
- Preferir formularios claros antes que interfaces “inteligentes” pero ambiguas.
- Evitar modales innecesarios si una pantalla o panel resuelve mejor.
- Mostrar siempre resúmenes económicos comprensibles.
...
- No mezclar transformación compleja de datos dentro del JSX.
...
- No bloquear al usuario con UX rígida innecesaria.
...
- No hace falta optimización extrema mobile-first, pero sí que no se rompa.
