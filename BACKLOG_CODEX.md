...
- BT-0006 — pruebas de integración con datasource/Flyway en entorno PostgreSQL real (requiere Docker disponible)

### PENDIENTE CRÍTICO
- (sin pendientes críticos del núcleo operativo)
...
- completar ejecución obligatoria de BT-0006 en entorno con Docker habilitado (hoy en PARCIAL por limitación de entorno)
