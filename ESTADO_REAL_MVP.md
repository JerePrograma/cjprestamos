...
- integración con datasource/Flyway en test automatizado PostgreSQL real: **PARCIAL** (implementado con Testcontainers, pendiente ejecución en entorno con Docker habilitado)
...
3. ejecutar sistemáticamente las pruebas de integración con base real de test (datasource/Flyway) en entorno con Docker disponible.
